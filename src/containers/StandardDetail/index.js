...
const boolStandards = [ ['antivirus_enabled', 'Antivirus'], ['antispyware_enabled', 'Antispyware'],
...
const intStandards = [ ['full_scan_age', 'Full-Scan Age'], ['quick_scan_age', 'Quick-Scan Age'],
              ...
              {intStandards.map(standard => {
                return (
                  <TableRow key={standard}>
                    ...
                    <TableCell className={classes.tableContent}>
                      max {this.props.content.standards[0][standard[0]]} days ago
                    </TableCell>
                  </TableRow>
                );
              })}
